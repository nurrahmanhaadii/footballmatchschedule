...
class DataDummy {
    fun footballData(): ArrayList<Football> {
        val listLeague = ArrayList<Football>()
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.german_bundesliga,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.italian_serie_a,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.spanish_la_liga,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.american_mayor_league,
                description =
        ...
        listLeague.add(
            Football(
                id = 4344,
                name = "Protugeuese Premiera Liga",
                image = R.drawable.portugeuese_premiera_liga,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.australian_a_league,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.scotish_premier_league,
                description =
        ...
        listLeague.add(
            Football(
                ...
                image = R.drawable.english_league,
                description =
